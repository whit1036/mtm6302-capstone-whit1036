...
- The buttons I designed speak for themselves, and gives the user an easy way to navigate around the website app. I’ve featured homebuttons for easy navigation back up to the top of the page, directional arrows (to scroll between saved images), hearts (for liking an image on the image generator section), and a garbage can (for deleting images on the favourites section).
