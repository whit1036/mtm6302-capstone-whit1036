...
I had some challenges getting the api array to work. Beginning with my empty parseArray, I used the parse method to get the objects in the array via local storage, which I then turned into a for loop to loop through the api data.
